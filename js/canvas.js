...
//   // 마우스 이벤트인 경우
//   else {
//     const x = (e.clientX - canvas.offsetLeft) / canvas.width * canvas.width;
//     const y = (e.clientY - canvas.offsetTop) / canvas.height * canvas.height;
//     context.beginPath();
//     context.moveTo(lastX, lastY);
//     context.lineTo(x, y);
//     context.stroke();
...
//   isDrawing = true;
//   lastX = (e.clientX - canvas.offsetLeft) / canvas.width * canvas.width;
//   lastY = (e.clientY - canvas.offsetTop) / canvas.height * canvas.height;
// });
